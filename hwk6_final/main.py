...
def equivalent(re1, re2):
    ...
    # print(re1_re2_Union_DFA)
    # print(re1_re2_Union_DFA.shortestString())
    if re1_re2_Union_DFA.shortestString() != None:
        return False
    else:
        return True
...
if __name__ == "__main__":
    ...
    # testEquivalence('ab', 'abc', False)
    # testEquivalence('a*b*', 'a*', False)
    # # testEquivalence('a|b', 'a|b', True)
    # testEquivalence('ab|cd', 'ab|csd', False)
    # testEquivalence('ab|cd*', 'ab|acd*', False)
